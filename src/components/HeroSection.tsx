        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 animate-fade-in-up">
            ...
            <p className="text-base md:text-lg text-white/90 max-w-xl leading-relaxed">
              Zamień zwiedzanie w grę. Odkryj sekrety Bydgoszczy, zbieraj pieczątki i poznaj historię miasta!
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                ...
                <div className="text-white/80">Wyzwań</div>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center mb-2">
                ...
                <div className="text-white/80">Odkrywców</div>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center mb-2">
                  <MapPin className="h-8 w-8 text-white animate-pulse" />
                </div>
                <div className="text-2xl font-bold text-white">Bydgoszcz</div>
