...
export const FlashcardsSection = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "Znajdź wyzwanie",
      subtitle: "Przeglądaj wyzwania na mapie lub liście",
      details: [
        { icon: Map, text: "Użyj mapy lub wyszukiwarki" },
        { icon: Target, text: "Filtruj po kategorii i lokalizacji" },
        { icon: Calendar, text: "Sprawdź kalendarz wyzwań" }
      ]
    },
    {
      number: 3,
      icon: Sparkles,
      title: "Przyjmij wyzwanie!",
      subtitle: "Jedno kliknięcie i zaczynasz grę",
      details: [
        { icon: MousePointer, text: "Kliknij 'Przyjmij wyzwanie'" },
        { icon: MessageCircle, text: "Czatuj z Mistrzem Gry" },
        { icon: Award, text: "Zbieraj odznaki i pieczątki" }
      ]
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Rozpocznij grę w trzech prostych krokach
          </p>
        </div>
