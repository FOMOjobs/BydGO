...
const VolunteerCenter = () => {
  ...
  useEffect(() => {
    ...
    map.current = new mapboxgl.Map({
      ...
      center: [18.0084, 53.1235], // Bydgoszcz coordinates (Wyspa Młyńska)
      zoom: 13,
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">BydGO! Centrum Dowodzenia</h1>
                <p className="text-muted-foreground">Twój hub do zarządzania grą miejską</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto p-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Szukaj wyzwań</CardTitle>
              </CardHeader>
          ...
          <div className="lg:col-span-2">
            <Card className="h-[600px]">
              <CardHeader>
                <CardTitle>Mapa wyzwań w Bydgoszczy</CardTitle>
                <CardDescription>Kliknij na znacznik, aby zobaczyć szczegóły wyzwania</CardDescription>
              </CardHeader>
      ...
      <Dialog open={showApplication} onOpenChange={setShowApplication}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Zgłoszenie do wyzwania</DialogTitle>
            <DialogDescription>
              Wypełnij formularz, aby przyjąć wyzwanie: {selectedInitiative?.title}
            </DialogDescription>
          </DialogHeader>
          ...
          <form onSubmit={handleApplicationSubmit} className="space-y-4">
            ...
            <div>
              <Label htmlFor="message">Dlaczego chcesz podjąć to wyzwanie?</Label>
              <Textarea
                id="message"
